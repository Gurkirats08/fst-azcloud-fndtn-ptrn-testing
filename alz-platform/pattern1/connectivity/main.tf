...
module "firewall_ip_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/publicip/v1.0?ref=main"
...
module "firewall_policy_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/firewallPolicy/v1.0?ref=main"
  main_location   = var.mainLocation
  environment     = var.environment
...
module "firewall_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/azurefirewall/v1.0?ref=main"
  resource_group_name = var.resourceGroups["netRG"].name
  location            = var.mainLocation
  environment         = var.environment
...
module "bastion_host_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/bastionhost/v1.0?ref=main"
  resourceGroupName = var.resourceGroups["basRG"].name
  main_location     = var.mainLocation
  environment       = var.environment
...
# #   source                   = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/=main"
