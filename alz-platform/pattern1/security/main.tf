...
module "security_resource_lock" {
  ...
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/resourcelock/v1.0?ref=main"
...
module "ddos_plan_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/ddos/v1.0?ref=main"
  main_location = var.mainLocation
  environment   = var.environment
...
module "data_collection_endpoint" {
  ...
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/datacollectionendpoint/v1.0?ref=main"
...
module "data_collection_rule" {
  ...
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/datacollectionrule/v1.0?ref=main"
...
module "sec_storage_backuppolicy_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/storagebackuppolicy/v1.0?ref=main"
...
module "sec_disk_backup_polcy_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/diskbackuppolicy/v1.0?ref=main"
...
module "hsm_private_endpoint" {
  ...
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/privateendpoint/v1.0?ref=main"
...
module "jumpbox_vm_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/windowsvm/v1.0-acc?ref=main"
  location                = var.mainLocation
...
module "antimalware_vm_extension_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/vmextension?ref=main"
...
module "diagnostic_setting_vm_extension_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/diagnosticlogs?ref=main"
  for_each                   = var.secJumpBoxVms
  resource_group_name        = each.value.resourceGroupName
...
module "sec_nsg_flow_logs_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/nsgflowlogs/v2.0?ref=main"
...
module "sec_keyvault_module" {
  ...
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/keyvault/v1.0?ref=main"
...
module "rbac" {
  ...
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/rbac/v1.0?ref=main"
...
module "azurerm_key_vault_key" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/keyvaultkey/v1.0?ref=main"
...
module "sec_network_peering" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/peering/v1.0?ref=main"
  providers = {
...
module "azurerm_private_dns_zone_virtual_network_link" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/privatednszone/v1.0?ref=main"
  providers = {
...
module "sec_recovery_service_vault" {
  ...
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/recoveryservicevault?ref=main"
...
module "vm_backup_policy_module" {
  source = "git::https://github.com/Gurkirats08/fst-azcloud-goldrepo-testing.git//modules-hub/terraform-modules/vmbackuppolicy/v1.0?ref=main"
